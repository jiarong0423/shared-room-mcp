...
- Current commercial WebMCP UI smoke passed on 2026-09-04 Asia/Taipei. Codex in-app browser against `http://127.0.0.1:3224` showed no old engineering UI strings or Chinese system text in English mode; `inspect_room` returned `productRoom`, `commercialFlow`, merchant/customer roles, scoped-room privacy, and proposal product status.
- Current local customer publishing stress passed 8/8 on 2026-09-04 Asia/Taipei. Evidence: `/private/tmp/webmcp-commercial-ui-customer-publishing-v2/customer-publishing-stress-2026-09-03T20-35-20-574Z.md`.
...
- Current guided OCR+LLM local smoke passed on 2026-09-04 Asia/Taipei. Evidence: `/private/tmp/webmcp-commercial-ui-codex-demo-v3/codex-ocr-llm-demo-2026-09-03T20-36-18-486Z.json`; Tesseract OCR produced 7 draft rows, Codex visual review prepared 18 structured rows, and merchant accept applied 18 rows while customer publishing stayed closed.
- Current release boundary scan passed on 2026-09-04 Asia/Taipei with blocking `0`. Evidence: `/Users/sunjiarong/Developer/webmcp/output/isolation/current_runs/webmcp_commercial_ui_20260904/release_boundary_final/release-boundary-report-2026-09-03T20-41-00-890Z.json`.
- Current `ai-security-rules rules-check` passed on 2026-09-04 Asia/Taipei with blocking `0`, P0 `0`, P1 `0`, P2 `0`. Evidence: `/Users/sunjiarong/Developer/webmcp/output/isolation/current_runs/webmcp_commercial_ui_20260904/ai_security_rules_check_final/local_security_design_gate_rules_check.md`.
- Current `ai-security-rules deploy-gate` passed on 2026-09-04 Asia/Taipei with blocking `0`, P0 `0`, P1 `0`, P2 `0`. Evidence: `/Users/sunjiarong/Developer/webmcp/output/isolation/current_runs/webmcp_commercial_ui_20260904/ai_security_deploy_gate_final/local_security_design_gate_deploy_gate.md`.
...
- Mermaid and narrative boundary rescan passed on 2026-09-04 Asia/Taipei. README and architecture diagrams now include the authorized local bridge, local OCR, Codex/Gemini/local-model LLM visual review, structured draft proposal, node permissions, and OCR-only blocker before customer publishing.
...
- Current guided OCR+LLM local smoke on 2026-09-04: `npm run demo:codex-ocr-llm -- --base-url http://127.0.0.1:3224 --accept-for-test` passed. Evidence: `/private/tmp/webmcp-commercial-ui-codex-demo-v3/codex-ocr-llm-demo-2026-09-03T20-36-18-486Z.json`. Tesseract OCR produced 7 draft rows from the generated evidence image; guided Codex visual review prepared 18 structured rows; merchant accept applied 18 rows and kept customer publishing closed. Zeabur live post-deploy smoke must be rerun after this commit is deployed.
