...
| Historical Railway production low-rate flow | 5/5 passed | sequential production browser/API check summarized in `docs/decisions/2026Q2/DEVELOPMENT_LOG.md` | historical only; Railway was removed before recording and the live demo now runs on Zeabur |
